...
class IncrFeatStridedConvFCUpsampReflectPadVAENoKL(Model):
    ...
    def __init__(self, latent_space_dims=32, kernel_size=3, **kwargs):
        super(IncrFeatStridedConvFCUpsampReflectPadVAENoKL, self).__init__(**kwargs)
        ...
        # Cycle period
        # TODO: Implement cyclic annealing
