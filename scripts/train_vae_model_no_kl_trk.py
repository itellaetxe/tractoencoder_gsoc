...
from tractoencoder_gsoc.models import vae_model_no_kl
VAE_no_KL = vae_model_no_kl.IncrFeatStridedConvFCUpsampReflectPadVAENoKL
...
if __name__ == "__main__":
    ...
    model = VAE_no_KL(latent_space_dims=args.latent_space_dims,
    ...
    early_stopping_monitor = tf.keras.callbacks.EarlyStopping(monitor='loss',
                                                              min_delta=0,
                                                              patience=100,
                                                              verbose=0,
                                                              mode='min',
